...
% NOTE: The traditional limits on Knudsen number for different flow regimes
% are different from what is used here. The current limits are imposed based
% on a study calibrating the bridging function to the results of DSMC
% simulations.
% Falchi, Alessandro, et al. "DSMC-based correction factor for low-fidelity
% hypersonic aerodynamics of re-entering objects and space debris." 
